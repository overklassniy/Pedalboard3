// OutputToggleProcessor.h - Simple processor which lets you toggle between outputs.
//
...
#ifndef OUTPUTTOGGLEPROCESSOR_H_
#define OUTPUTTOGGLEPROCESSOR_H_
...
class OutputToggleProcessor : public PedalboardProcessor
{
  public:
    ...
    const String getName() const override { return "Output Toggle"; }
    /// Ignored.
