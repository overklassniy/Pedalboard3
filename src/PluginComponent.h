                        ...
                        public juce::Label::Listener
{
  public:
    ...
    AudioProcessorGraph::Node::Ptr getNode() const { return node; }
    /// Returns the plugin's user name.
    const juce::String& getUserName() const { return pluginName; }
  ...
  private:
    ...
    std::unique_ptr<juce::TextButton> mappingsButton;
    ...
    juce::GlyphArrangement nameText;
    /// Used to draw the names of the input channels.
    juce::OwnedArray<juce::GlyphArrangement> inputText;
...
class PluginPinComponent : public juce::Component
{
  public:
    ...
    /// Returns this pin's plugin's node ID.
    AudioProcessorGraph::NodeID getUid() const { return uid; }
  ...
  private:
    ...
    AudioProcessorGraph::NodeID uid;
    /// Which channel of the plugin this pin represents.
    int channel;
    /// Whether this is an audio or parameter(/midi) pin.
    bool parameterPin;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(PluginPinComponent)
};
                         ...
                         public juce::ChangeListener
{
  ...
  private:
    ...
    bool paramCon;
    /// Whether this connection is intended to represent all outputs on its
    /// source component or not.
