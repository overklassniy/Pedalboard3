    ...
    lastComboBox(0)
{
    ...
    presetsLabel = std::make_unique<Label>("presetsLabel",
                                                             "Presets:");
    ...
    importButton = std::make_unique<DrawableButton>("importButton",
    ...
    std::unique_ptr<Drawable> openImage(loadSVGFromMemory(Vectors::openbutton_svg,
